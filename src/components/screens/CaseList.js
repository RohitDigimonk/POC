...
onHandleSort=(value)=>{
  this.hideMenu()
    ...
    <View>
      <View style={{top: 0, height: 55, backgroundColor: '#02a8ee', width: '100%', flexDirection: 'row', justifyContent: 'space-between' }}>
      ...
      <Image
       ...
       <Text style={{fontSize: 18, color: 'white', justifyContent: 'center', marginLeft: 120, marginTop: 10}}>Case Study</Text>
      ...
      <Image
        ref={this.textRef}
        style={{width: 25, height: 25, marginTop: 10, marginLeft: 85}}
        source={require('../image/filter.png')}
        ...
        <ScrollView>
         ...
         <CardSection>
                  ...
                  <View style={[styles.headerContentStyle]} key={cases.id}>
                    ...
                    <Text style={{fontWeight: cases.finalstatus==0?'bold':'normal', flexWrap: 'wrap'}}>{cases.case_study_title}</Text>
